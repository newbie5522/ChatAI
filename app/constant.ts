export const OWNER = "newbie5522";
export const REPO = "ChatAI";
export const REPO_URL = `https://github.com/${OWNER}/${REPO}`;
export const PLUGINS_REPO_URL = `${REPO_URL}/tree/main/public`;
...
5. EXAMPLE INTERACTION:
  ...
  "params": {
    "name": "write_file",
    "arguments": {
      "path": "/Users/river/dev/newbiechat/test/joke.txt",
...
\`\`\`
   ...
   \`\`\`json:mcp:filesystem
   {
      "method": "write_file",
      "params": {
        "path": "NewbieChat_Information.txt",
        "content": "1"
    }
   }
   \`\`\`

...
const en: LocaleType = {
  ...
  Error: {
    Unauthorized: isApp
      ? `Access is not configured yet. Please contact your administrator or review the local settings.`
      : `Access is not configured yet. If this is a private deployment, [enter your access code](/#/auth) or review the local settings.`,
  },
  Auth: {
    Return: "Return",
    Title: "Employee Access Key",
    Tips: "Enter the internal key assigned by your company.",
    SubTips: "Provider API keys are managed by your company.",
    Input: "employee access key",
    Confirm: "Confirm",
    Later: "Later",
    SaasTips: "Contact your administrator for access.",
    TopTips: "NewbieChat is a company internal AI workspace.",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "NewbieChat Access",
        Label: "",
        SubTitle: "Use the internal access method configured by your company.",
        ChatNow: "Open",
      },
      AccessCode: {
        Title: "Employee Access Key",
        SubTitle: "Use the internal key assigned by your company.",
        Placeholder: "Enter employee access key",
      },
      CustomEndpoint: {

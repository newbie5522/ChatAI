...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `当前访问尚未配置，请联系管理员或检查本地设置。`
      : `当前访问尚未配置。如果这是私有部署，请点击[这里](/#/auth)输入访问码，或检查本地设置。`,
  },
  Auth: {
    Return: "返回",
    Title: "员工访问密钥",
    Tips: "请输入公司分配的内部访问密钥。",
    SubTips: "官方 Provider API Key 由公司统一管理。",
    Input: "在此处填写员工访问密钥",
    Confirm: "确认",
    Later: "稍后再说",
    SaasTips: "请联系管理员获取访问权限",
    TopTips: "NewbieChat 是公司内部 AI 工作台",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "NewbieChat 访问",
        Label: "",
        SubTitle: "请使用公司配置的内部访问方式。",
        ChatNow: "打开",
      },
      AccessCode: {
        Title: "员工访问密钥",
        SubTitle: "使用公司分配的内部访问密钥。",
        Placeholder: "请输入员工访问密钥",
      },
      CustomEndpoint: {
        Title: "自定义接口",

...
export function RealtimeChat({
  ...
  const apiKey = accessStore.hideUserApiKey ? "" : config.realtimeConfig.apiKey;
  ...
  const handleConnect = async () => {
    ...
    if (accessStore.hideUserApiKey) {
      setStatus("Realtime voice is unavailable in company access mode.");
      return;
    }
    if (!isConnected) {
      try {

...
export function ModelConfigList(props: {
  ...
  const category = selectedModel?.category ?? "chat";
  const showTextGenerationSettings =
    category === "chat" || category === "search";
    ...
    <>
      ...
      {showTextGenerationSettings && (
        <>
          ...
          <ListItem
            title="单次回复上限"
            subTitle="限制单次回复最多生成的 Token 数。"
          >
            <div className={styles["number-with-unit"]}>
              <input
                aria-label="单次回复上限"
                type="number"
                min={1024}
      ...
      {showTextGenerationSettings && (
        <>
          ...
          <ListItem
            title="历史消息压缩阈值（估算 Token）"
            subTitle="达到阈值后压缩较早的历史消息。"
          >
            <div className={styles["number-with-unit"]}>
              <input
                aria-label="历史消息压缩阈值（估算 Token）"
                type="number"
                min={2000}
                max={64000}
